...
```{r}
sgd = function(epoch, steps, sample_count, validation_count, data, test_data, parameters, lambda) {
  ...
  for (epoch in 1:epoch) {
    ...
    for (step in 1:steps){
      ...
      #update a and b
      v_a = v_a - steplength/sample_count * (colSums(-y[h < 1] * x) + lambda * v_a)
...
sgd(50, 300, 50, valid_count, adult_data[-test_indexes,], adult_data[test_indexes,], params, lambdas[1])
```
