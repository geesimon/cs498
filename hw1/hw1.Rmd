...
load_label_data = function(file_name){
  ...
  sb_bin_train_data[sb_bin_train_data > 128] = 255
  sb_bin_train_data[sb_bin_train_data <= 128] = 0
  sb_bin_test_data[sb_bin_test_data > 128] = 255
...
for(i in index)
{
  image(matrix(sb_bin_train_data[i,], 28, 28)[, 28:1], col  = gray((255:0)/255))
}
```


##Part A
Investigate classifying MNIST using naive Bayes. Fill in the accuracy values for the four combinations of Gaussian v. Bernoulli distributions and untouched images v. stretched bounding boxes. We use 20 x 20 for your bounding box dimensions.
