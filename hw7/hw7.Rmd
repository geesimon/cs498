...
set.seed(19720816) #Only for homework, set seed for consistent output
...
From the output image, I do see some variations (local optimal) although the differences not are as obvious as the ones produced by different segments. The output of new centers and $\pi$ can tell the different as illustrated below.
