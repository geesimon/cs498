...
We vector quantize training and test dataset and compute the histgram of these dataset to make features for later classification.
```{r}
...
### Modifying the number of cluster centers in k-means
```{r}
...
for (i in 1:length(cluster_number)){
  ...
  result = get_best_classifier(h2o_train_data, h2o_test_data, c(20, 30), c(8, 16))
...
### Modifying the size of the fixed length samples to use
