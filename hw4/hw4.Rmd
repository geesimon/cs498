...
```{r}
cluster_number = c(100, 200, 300, 400, 500, 600, 700, 800, 900, 1000)
sample_size = c(16, 24, 32, 40, 48, 56, 64)
```
...
for (i in 1:length(sample_size)){
  km = kmeans(AllTrainDF, centers = 480)
  ...
  accuracies[i] = get_best_classifier(h2o_train_data, h2o_test_data, c(20, 30), c(8, 16))
